        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Grup Arisan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grup arisan</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card shadow-sm p-3 mb-5 bg-body rounded">
                                    <div class="d-flex justify-content-between align-items-center">
                                       <h3 class="m-0">Nama Grup</h3>
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-primary mx-1 rounded-0">Lihat</button>
                                            <button type="button" class="btn btn-warning mx-1 rounded-0">Edit</button>
                                            <button type="button" class="btn btn-danger mx-1 rounded-0">Hapus</button>
                                        </div>
                                    </div>
                                </div>
